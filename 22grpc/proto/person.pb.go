...
func (x *SucessResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SucessResponse) ProtoMessage() {}

func (x *SucessResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_person_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SucessResponse.ProtoReflect.Descriptor instead.
func (*SucessResponse) Descriptor() ([]byte, []int) {
	return file_proto_person_proto_rawDescGZIP(), []int{4}
}

func (x *SucessResponse) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
const file_proto_person_proto_rawDesc = "" +
	...
	"\x0eSucessResponse\x12\x1a\n" +
	"\bresponse\x18\x01 \x01(\tR\bresponse2\xcf\x02\n" +
	"\rPersonService\x12R\n" +
	"\x06Create\x12\".personservice.CreatePersonRequest\x1a$.personservice.PersonProfileResponse\x12P\n" +
	"\x04Read\x12\".personservice.SinglePersonRequest\x1a$.personservice.PersonProfileResponse\x12K\n" +
	"\x06Update\x12\".personservice.UpdatePersonRequest\x1a\x1d.personservice.SucessResponse\x12K\n" +
	"\x06Delete\x12\".personservice.SinglePersonRequest\x1a\x1d.personservice.SucessResponseB\x0eZ\f22grpc/protob\x06proto3"
...
var file_proto_person_proto_goTypes = []any{
	...
	(*SucessResponse)(nil),        // 4: personservice.SucessResponse
}
var file_proto_person_proto_depIdxs = []int32{
	...
	4, // 6: personservice.PersonService.Update:output_type -> personservice.SucessResponse
	4, // 7: personservice.PersonService.Delete:output_type -> personservice.SucessResponse
